...
extension ABIEncoder {
    public static func encode(_ value: String) throws -> [UInt8] {
        guard let addressType = ABIRawType(type: String.self) else {
            throw ABIError.invalidType
        }
        
        return try ABIEncoder.encode(value, forType: addressType)
    }
